 ...
 */
typedef DLManagedTensorVersioned* int (*DLPackManagedTensorAllocator)(      //
  DLTensor* prototype, void* error_ctx,                                     //
 ...
 */
typedef DLManagedTensorVersioned* (*DLPackManagedTensorFromPyObjectNoSync)(  //
  struct PyObject* py_object                                                 //
);
 ...
 *        the data is stolen.
 * \return Python object or NULL with a Python exception set.
 *
 * \sa DLPackExchangeAPI
 */
struct PyObject * (*DLPackManagedTensorToPyObjectNoSync)(  //
